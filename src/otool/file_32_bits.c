...
/*   Updated: 2019/02/13 16:13:13 by fhuang           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_section(struct section *section, const void *ptr, void *end_of_file, uint8_t swap)
{
	uint32_t	i;
	uint32_t	j;
	uint32_t	size;
...
static void	parse_sections_32(t_nm_otool *nm_otool, struct segment_command *segment, const void *ptr, uint8_t swap)
{
	uint32_t			i;
	...
	while (is_ptr_in_file(nm_otool->end_of_file, section + i) && i < swap_32(segment->nsects, swap))
	{
...
void		otool_32_bits(t_nm_otool *nm_otool, void *ptr, const char *filename, uint8_t swap)
{
